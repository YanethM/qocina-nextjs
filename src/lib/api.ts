...
export async function getProductosPage(locale?: string, siteCode?: string) {
  const res = await fetchAPI<StrapiSingleResponse<ProductosPage>>("/api/productos-page", {
    ...
    "populate[packs_destacados][populate][componentes][populate][producto][populate][sitios][populate][site]": "*",
...
export async function getRecetasPage(locale?: string, siteCode?: string) {
  return fetchAPI<StrapiSingleResponse<RecetasPage>>("/api/recetas-page", {
    ...imgFields("hero_imagen"),
    ...imgFields("hero_imagen_mobile"),
    ...imgFields("base_verde_desktop_default"),
    ...imgFields("base_verde_desktop_detalle"),
    ...imgFields("base_verde_desktop_resumen"),
    ...imgFields("base_verde_mobile_default"),
    ...imgFields("base_verde_mobile_detalle"),
    ...imgFields("base_amarilla_desktop_default"),
    ...imgFields("base_amarilla_desktop_detalle"),
    ...imgFields("base_amarilla_desktop_resumen"),
    ...imgFields("base_amarilla_mobile_default"),
    ...imgFields("base_amarilla_mobile_detalle"),
    ...imgFields("base_roja_desktop_default"),
    ...imgFields("base_roja_desktop_detalle"),
    ...imgFields("base_roja_desktop_resumen"),
    ...imgFields("base_roja_mobile_default"),
    ...imgFields("base_roja_mobile_detalle"),
...
export async function getHomePage(locale?: string, siteCode?: string) {
  return fetchAPI<StrapiSingleResponse<HomePage>>("/api/home-page", {
    ...
    "populate[intro_badges][populate][icono][fields][0]": "url",
    "populate[intro_badges][populate][icono][fields][1]": "alternativeText",
    "populate[intro_badges][populate][icono][fields][2]": "width",
    "populate[intro_badges][populate][icono][fields][3]": "height",
    "populate[intro_badges][populate][icono][fields][4]": "formats",
    "populate[video_cover][fields][0]": "url",
    "populate[video_cover][fields][1]": "alternativeText",
    "populate[video_cover][fields][2]": "width",
    ...
    "populate[secreto_badges][populate][icono][fields][3]": "height",
