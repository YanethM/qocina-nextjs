              ...
              <div key={perfil.id} className={styles.paraQuienRow}>
                ...
                <div
                  className={`${styles.paraQuienCircle} ${
                    isReversed ? styles.paraQuienCircleRight : styles.paraQuienCircleLeft
                  }`}>
                  {imagenUrl && (
                    <Image
                      src={imagenUrl}
                ...
                <div
                  className={`${styles.paraQuienText} ${
                    isReversed ? styles.paraQuienTextLeft : styles.paraQuienTextRight
                  }`}>
                  <h3 className={styles.paraQuienItemTitle}>{perfil.titulo}</h3>
                  <p className={styles.paraQuienItemDesc}>{perfil.descripcion}</p>
                </div>
              </div>
            );
          })}
